        ...
        public async Task<IActionResult> EditPost(BackgroundImages image)
        {
            ...
            if (image.PhotoOne != null)
            {
                ...
                if (image.PhotoOne.ContentType.Contains("image/"))
                {
                    ...
                    string filename = await image.PhotoOne.SaveWithoutFolderAsync(_env.WebRootPath);
            ...
            if (image.PhotoTwo != null)
            {
                ...
                {
                    string filename = await image.PhotoTwo.SaveWithoutFolderAsync(_env.WebRootPath);
            ...
            if (image.PhotoThree != null)
            {
                ...
                {
                    string filename = await image.PhotoThree.SaveWithoutFolderAsync(_env.WebRootPath);
            ...
            if (image.PhotoFour != null)
            {
                ...
                {
                    string filename = await image.PhotoFour.SaveWithoutFolderAsync(_env.WebRootPath);
            ...
            if (image.PhotoFive != null)
            {
                ...
                {
                    string filename = await image.PhotoFive.SaveWithoutFolderAsync(_env.WebRootPath);
