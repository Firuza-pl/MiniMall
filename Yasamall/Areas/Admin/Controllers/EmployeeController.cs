    ...
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Create(RegisterViewModel registerViewModel)
        {
            ...
            if ( registerViewModel.Photo != null)
            {
                ...
                string filename = await registerViewModel.Photo.SaveAsync(_env.WebRootPath, "users");
            ...
            else
            {
                newUser = new AppUser
                {
                    ...
                    UserName = registerViewModel.Username.Trim(),
                    PhoneNumber = registerViewModel.Phone.Trim(),
                    PhotoURL = "users/Person-icon.png"
                };
            }
        ...
        public async Task<IActionResult> EditPost(AppUser user)
        {
            ...
            if (user.Photo != null)
            {
                ...
                {
                    if (newUser.PhotoURL != "users/Person-icon.png")
                    {
                ...
                string filename = await user.Photo.SaveAsync(_env.WebRootPath, "users");
